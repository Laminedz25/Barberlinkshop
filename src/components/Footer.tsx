        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <a href="#" className="text-muted-foreground hover:text-[#1877F2] transition-colors" aria-label="Facebook">
              ...
              <a href="#" className="text-muted-foreground hover:text-[#FFFC00] transition-colors" aria-label="Snapchat">
                <SnapchatIcon />
              </a>
              <a href="#" className="text-muted-foreground hover:text-[#FF0000] transition-colors" aria-label="Youtube">
